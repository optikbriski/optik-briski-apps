...
void main() {
  test('situs publik Rekasa siap kolom link Midtrans', () {
    ...
    expect(File('site/syarat.html').readAsStringSync(), contains('nav-links'));
    expect(File('site/kebijakan.html').readAsStringSync(), contains('nav-links'));
    expect(File('site/kontak.html').readAsStringSync(), contains('nav-links'));
