-- Align recognize_stock_variance dengan audit Flutter:
-- agregasi ledger case-insensitive (SKU + toko) agar catat selisih
-- menutup kebocoran yang terdeteksi meski casing SKU beda di ledger.
